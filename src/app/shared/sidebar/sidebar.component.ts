...
export class SidebarComponent {
  ...
  items: NavItem[] = [
    ...
    { path: '/cotizador', label: 'Cotizador', icon: 'M9 12h6m-6 3h6m2.25 6H6.75A2.25 2.25 0 0 1 4.5 18.75V5.25A2.25 2.25 0 0 1 6.75 3h8.379a1.5 1.5 0 0 1 1.06.44l4.122 4.12A1.5 1.5 0 0 1 21 8.622V18.75A2.25 2.25 0 0 1 18.75 21Z' },
  ];
}
